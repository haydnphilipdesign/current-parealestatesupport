  ...
  return (
    <section className="py-24 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-gray-50 to-white">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_transparent_0%,_rgba(0,0,0,0.02)_100%)]" />
      ...
      <div className="container mx-auto px-4 relative">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="absolute -inset-4 rounded-2xl bg-gradient-to-r from-brand-blue/20 to-brand-gold/20 blur-lg group-hover:blur-xl transition-all duration-300 opacity-0 group-hover:opacity-100" />
            <div className="relative">
              <div className="absolute -inset-1 bg-gradient-to-r from-brand-blue to-brand-gold rounded-2xl opacity-75 blur group-hover:opacity-100 transition-opacity duration-300" />
              <img
                src="/bushkill_falls.jpg"
                alt="Bushkill Falls"
          ...
          >
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-gray-800 font-serif leading-tight">
                Transforming Complex Transactions into Seamless Success Stories
              </h2>
              <p className="text-xl text-brand-blue italic font-serif">
